...
from pywizlight import BulbClass, BulbType, Features
from pywizlight import get_id_from_scene_name
...
def _async_pilot_builder(custom_effect_manager: CustomEffectManager, **kwargs: Any) -> PilotBuilder:
    ...
    if ATTR_EFFECT in kwargs:
        ...
        # Handle predefined scenes
        scene_id = get_id_from_scene_name(effect_name)
